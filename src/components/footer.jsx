import logolight from '../images/logo/logo-white-1.png';

export default function Footer() {
    return (
        <>
            <footer className="footer-layout-img">
                <section className="section-b-space footer-1">
                    <div className="custom-container container">
                        <div className="row">
                            <div className="col-xl-3 col-lg-4 col-md-6">
                                <div className="footer-content">
                                    ...
                                    <ul>
                                        <li>
                                            {" "}
                                            <i className="iconsax" data-icon="location">
                                                <svg
                                                    width={24}
                                                    height={24}
                                                    viewBox="0 0 24 24"
                                            ...
                                            <h6>
                                                Huỳnh Phúc Kháng, Quận 1, TPHCM
                                            </h6>
                                        </li>
                                        <li>
                                            {" "}
                                            <i className="iconsax" data-icon="phone-calling">
                                                <svg
                                                    width={24}
                                                    height={24}
                                                    viewBox="0 0 24 24"
                            ...
                            <div className="col offset-xl-1">
                                <div className="footer-content">
                                    <div>
                                        <div className="footer-title d-md-block">
                                            <h5>Menu</h5>
                                            <ul className="footer-details accordion-hidden">
                                                <li>
                                                    {" "}
                                                ...
                                                <li>
                                                    {" "}
                                                    <a className="nav" href="/view-product">
                                                        Sản phẩm
                                                    </a>
                                                </li>
                                                <li>
                                                    {" "}
                                                    <a className="nav" href="/view-about-us">
                                                        Về chúng tôi
                                                    </a>
                                                </li>
                                                <li>
                                                    {" "}
                                                    <a className="nav" href="/view-contact">
                                                        Liên hệ
                                                    </a>
                                                </li>
                                            </ul>
